...
#
# This file should be in the "pa2data" subdirectory of the directory where you are doing your Lab 3.  To run it do:
#
#         chmod 755 ./pa2data/pa2-change-ports.csh
#         ./pa2data/pa2-change-ports.csh YOURPORT
#
...
#     entire "pa2data" subdirectory by running the following command before running this command again:
#
#         tar xvf pa2data.tar.gz
...
set rc = `grep 12345 ${dir}/pa2-startup.ini | wc -l`
if ($rc == 0) then
...
foreach f (${dir}/pa2-D-1.csh ${dir}/pa2-D-2.csh ${dir}/pa2-E-1.csh ${dir}/pa2-H-1.csh ${dir}/pa2-H-2.csh ${dir}/pa2-setup.csh ${dir}/pa2-startup-cout.ini  ${dir}/pa2-startup.ini)
    set port=${baseport}
